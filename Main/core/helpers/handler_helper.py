...
from Main.core.helpers.logging_helper import info as _info, warn as _warn, exception as _exception, debug as _debug # type: ignore

def add_app_handler( function_: Callable, filters_: Filter, name: str, group: int = 0): # type: ignore
...
def add_bot_handler( function_: Callable, filters_: Filter, name: str, group: int = 0): # type: ignore
